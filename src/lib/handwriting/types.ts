...
export const HANDWRITING_STYLES: HandwritingStyle[] = [
  ...
  { id: 'indie', name: 'Slightly Messy', fontClass: 'font-handwriting-indie', description: 'Casual, slightly irregular', category: 'messy', charWidthFactor: 0.9 },
  ...
  { id: 'just', name: 'Tall & Narrow', fontClass: 'font-handwriting-just', description: 'Tall, compressed characters', category: 'casual', charWidthFactor: 0.78 },
